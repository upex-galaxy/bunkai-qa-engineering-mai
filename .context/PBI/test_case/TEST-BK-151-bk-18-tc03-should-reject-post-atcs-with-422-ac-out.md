# TEST: BK-18: TC03: should reject POST /atcs with 422 ac_outside_user_story when an acceptance criterion belongs to a different user story

**Jira Key:** [BK-151](https://jira.upexgalaxy.com/browse/BK-151)
**Status:** Candidate
**Components:** None
