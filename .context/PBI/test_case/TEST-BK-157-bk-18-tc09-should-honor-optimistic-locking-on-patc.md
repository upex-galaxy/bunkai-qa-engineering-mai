# TEST: BK-18: TC09: should honor optimistic locking on PATCH /atcs/{id} (200 matching X-If-Match / 409 stale / 200 absent)

**Jira Key:** [BK-157](https://jira.upexgalaxy.com/browse/BK-157)
**Status:** Candidate
**Components:** None
