# TEST: BK-18: TC01: should create an ATC and return 201 with steps, assertions, slug and version 1 when POST /atcs receives a valid payload

**Jira Key:** [BK-149](https://jira.upexgalaxy.com/browse/BK-149)
**Status:** Candidate
**Components:** None
