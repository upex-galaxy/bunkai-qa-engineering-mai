# TEST: BK-18: TC12: should keep slug, user_story_id and module_id immutable when PATCH /atcs/{id} attempts to change them

**Jira Key:** [BK-160](https://jira.upexgalaxy.com/browse/BK-160)
**Status:** Candidate
**Components:** None
