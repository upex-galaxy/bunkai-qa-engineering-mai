# TEST: BK-18: TC05: should reject POST /atcs with 422 steps_position_invalid when step positions are not strictly increasing from 1

**Jira Key:** [BK-153](https://jira.upexgalaxy.com/browse/BK-153)
**Status:** Candidate
**Components:** None
